                ...
                datasets: [
                    {
                        label: "2019",
                        data: [
                            42, 42, 30, 30, 18, 22, 16, 21, 22, 22, 22, 20, 24,
                            20, 18, 22, 30, 34, 32, 33, 33, 24, 32, 34, 30, 34,
                            19, 34, 18, 10, 22, 24, 20, 22, 20, 21, 10, 10, 5,
                            9, 14,
                        ],
                    ...
                    },
                    {
                        label: "2018",
                        data: [
                            35, 28, 32, 42, 44, 46, 42, 50, 48, 30, 35, 48, 42,
                            40, 54, 58, 56, 55, 59, 58, 57, 60, 66, 54, 38, 40,
                            42, 44, 42, 43, 42, 38, 43, 41, 43, 50, 58, 58, 68,
                            72, 72,
                        ],
                        borderColor: ["transparent"],
                        borderWidth: 2,
                    ...
                    },
                    {
                        label: "Past years",
                        data: [
                            98, 88, 92, 90, 98, 98, 90, 92, 78, 88, 84, 76, 80,
                            72, 74, 74, 88, 80, 72, 62, 62, 72, 72, 78, 78, 72,
                            75, 78, 68, 68, 60, 68, 70, 75, 70, 80, 82, 78, 78,
                            84, 82,
                        ],
                        borderColor: ["transparent"],
                        borderWidth: 2,
