                ...
                @forelse($cart as $cartItem)
                    ...
                    <div class="cart-item">
                        <div class="row">
                            ...
                            <div class="col-md-2 my-auto cart-centre">
                                <button type="button" class="quantitybtn" wire:loading.attr="disabled" wire:click= "decreaseQuantity({{$cartItem->id}})" class="quantitybtn"><i class="fa fa-minus" id="quantitybtn"></i></button>
                                <input type="text" value="{{ $cartItem->quantity}}" class="cart-quantity cart-centre" placeholder="0"/>
                                <button type="button" class="quantitybtn" wire:loading.attr="disabled" wire:click= "increaseQuantity({{$cartItem->id}})" class="quantitybtn"><i class="fa fa-plus" id="quantitybtn"></i></button>
                            </div>
                            <div class="col-md-1 my-auto cart-centre">
                                <label class="cart-price">
